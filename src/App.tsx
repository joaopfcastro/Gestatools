...
export default function App() {
  ...
  return (
    <div className={`h-[var(--vv-height,100dvh)] min-h-[var(--vv-height,100dvh)] flex overflow-hidden bg-background text-on-surface transition-colors duration-300 ${isDarkMode ? 'dark' : ''}`}>
      ...
      {/* Main Content Area */}
      <main className="app-main flex-1 min-h-0 min-w-0 w-full md:w-auto px-1.5 sm:px-4 md:px-5 min-[1024px]:px-6 min-[1366px]:px-margin-desktop overflow-y-auto overscroll-contain z-10 relative pt-[calc(48px+env(safe-area-inset-top))] md:pt-16 min-[1366px]:pt-20 pb-[calc(60px+env(safe-area-inset-bottom))] md:pb-6 min-[1366px]:pb-margin-desktop">
