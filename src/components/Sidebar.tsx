...
export default function Sidebar({ activeTab, setActiveTab }: SidebarProps) {
  ...
  return (
    <nav className="glass-nav text-on-surface font-body-lg hidden md:flex flex-col h-[calc(var(--vv-height,100dvh)-56px)] w-[224px] min-[1366px]:w-72 fixed left-0 top-[calc(48px+env(safe-area-inset-top))] md:top-[calc(56px+env(safe-area-inset-top))] overflow-y-auto z-40">
